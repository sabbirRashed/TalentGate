...
import { Button, TextField, Label, Input, FieldError, Spinner, Radio, RadioGroup } from "@heroui/react";
    ...
    const handleRegister = async (e) => {
        ...
        try {
            await authClient.signUp.email(
                ...
                {
                    onSuccess: () => {
                        setFormMessage({ type: "success", text: "Welcome! Successfully created your account." });
                    ...
                    <div className="flex items-center justify-center p-8 md:p-10">
                        <div className="w-full max-w-md">
                            ...
                            <form onSubmit={handleRegister} className="space-y-5">
                                ...
                                {formMessage && (
                                    <p
                                        className={`px-4 py-2 rounded-xl text-sm ${formMessage.type === "success"
