                    ...
                    <Table.Content>
                        ...
                        <Table.Body>
                            {users.map((user) => {
                                ...
                                const userIdStr = user._id?.toString() || user.email;
                                            ...
                                            <div className="flex items-center justify-end gap-2">
                                                {role !== 'recruiter' && (
                                                    <Button
                                                        size="sm"
                                                        variant="flat"
                                                        onPress={() => handleRoleToggle(user.id, 'recruiter')}
                                                ...
                                                {role !== 'admin' && (
                                                    <Button
                                                        size="sm"
                                                        variant="flat"
                                                        onPress={() => handleRoleToggle(user.id, 'admin')}
                                                        className="text-xs font-medium bg-zinc-800/60 text-zinc-300 border border-zinc-700/50 hover:bg-zinc-700/60 min-w-0 h-auto py-1 px-2.5 rounded-md"
                                                    >
                                                        Make Admin
                                                    </Button>
                                                ...
                                                <Button
                                                    size="sm"
                                                    variant="flat"
                                                    onPress={() => handleStatusToggle(user._id)}
